...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.dental.clinic'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'نظام إدارة عيادة الأسنان'),
     ...
     */
    'queue_workers' => [
        // Sync queue is used for desktop; no background workers needed.
    ],
